...
export default function Grayscale() {
  ...
  const handleProcess = async () => {
    ...
    for (const file of files) {
      const processed = await applyGrayscale(file);
  ...
  const applyGrayscale = (file: File): Promise<{ name: string; url: string }> => {
    return new Promise((resolve) => {
      ...
      reader.onload = (event) => {
        ...
        img.onload = () => {
          ...
          resolve({
            name: file.name.replace(/\.[^/.]+$/, "") + "_grayscale.jpg",
    ...
    <div className="py-12 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-extrabold text-gray-900 mb-4 uppercase tracking-tight">Grayscale IMAGE</h1>
          <p className="text-xl text-gray-600">Convert your images to black and white instantly.</p>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
              <div className="flex items-center justify-between mb-8">
                <h2 className="text-2xl font-bold text-gray-900">Images converted to grayscale!</h2>
                <button 
